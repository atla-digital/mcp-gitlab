...
export const getIntegration: ToolHandler = async (params, context) => {
  ...
  const data = await context.integrationsManager.getIntegration(
    project_id as string | number,
    integration_slug as string
  );
  return formatResponse(data);
};
...
export const updateSlackIntegration: ToolHandler = async (params, context) => {
  ...
  const data = await context.integrationsManager.updateSlackIntegration(
    project_id as string | number,
    {
...
export const disableSlackIntegration: ToolHandler = async (params, context) => {
  ...
  const data = await context.integrationsManager.disableSlackIntegration(
    project_id as string | number
  );
  return formatResponse(data);
};
...
export const getWebhook: ToolHandler = async (params, context) => {
  ...
  const data = await context.integrationsManager.getWebhook(
    project_id as string | number,
...
export const addWebhook: ToolHandler = async (params, context) => {
  ...
  const data = await context.integrationsManager.addWebhook(
    project_id as string | number,
    options as {
      url: string;
      name?: string;
